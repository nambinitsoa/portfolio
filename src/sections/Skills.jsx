...
export default function Skills() {
    ...
    // ✅ Traduction des labels seulement
    const tabs = [

        { id: "languages", label: language === "fr" ? "Langages" : "Languages" },
        { id: "frameworks", label: "Frameworks" },
        { id: "databases", label: language === "fr" ? "Bases de données" : "Databases" },
        { id: "tools", label: language === "fr" ? "Outils" : "Tools" },
        { id: "domains", label: language === "fr" ? "Domaines techniques" : "Technical Domains" },
        { id: "methods", label: language === "fr" ? "Méthodes et concepts" : "Methods & Concepts" },
